...
local function evaluate_emote_barrier()
    ...
    elseif emote_barrier.phase == "G" then
        ...
        if complete then
            ...
            publish_emote_phase(emote_barrier)
            if failed and not emote_barrier.resync_broadcast then
                emote_barrier.resync_broadcast = true
    ...
    elseif emote_barrier.phase == "F" then
        ...
        if all_reset then
            ...
            emote_barrier.reset = {}
            emote_barrier.resync_broadcast = false
            emote_ready_epoch = -1
            publish_emote_phase(emote_barrier)
        end
    end
